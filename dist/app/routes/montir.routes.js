...
montirRouter.get("/get-detail-bengkel-order-service/:orderId", auth_1.AuthMiddleware.verifyToken, auth_1.AuthMiddleware.isAdminBengkel, montir_controller_1.MontirController.getDetailMontirOrderService);
montirRouter.get("/get-completed-bengkel-order-service", auth_1.AuthMiddleware.verifyToken, auth_1.AuthMiddleware.isAdminBengkel, montir_controller_1.MontirController.getCompletedMontirOrderService);
montirRouter.get("/get-cancelled-bengkel-order-service", auth_1.AuthMiddleware.verifyToken, auth_1.AuthMiddleware.isAdminBengkel, montir_controller_1.MontirController.getCanceledMontirOrderService);
