...
adminRouter.post("/create-education", auth_1.AuthMiddleware.verifyToken, auth_1.AuthMiddleware.isAdmin, edukasi_controller_1.EducationController.createEducation, multer_1.default.array('foto_url'));
