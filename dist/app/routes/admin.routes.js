...
adminRouter.put("/edit-education/:contentId", multer_1.default.array('foto_url'), auth_1.AuthMiddleware.verifyToken, auth_1.AuthMiddleware.isAdmin, admin_controller_1.AdminController.updateContent);
adminRouter.delete("/delete-education/:contentId", auth_1.AuthMiddleware.verifyToken, auth_1.AuthMiddleware.isAdmin, admin_controller_1.AdminController.deleteContent);
