...
montirRouter.get("/get-detail-bengkel-order-service/:orderId", AuthMiddleware.verifyToken, AuthMiddleware.isAdminBengkel, MontirController.getDetailMontirOrderService);
montirRouter.get("/get-completed-bengkel-order-service", AuthMiddleware.verifyToken, AuthMiddleware.isAdminBengkel, MontirController.getCompletedMontirOrderService);
montirRouter.get("/get-cancelled-bengkel-order-service", AuthMiddleware.verifyToken, AuthMiddleware.isAdminBengkel, MontirController.getCanceledMontirOrderService);
